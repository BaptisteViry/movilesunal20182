...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: init main2 activity for research");
        ...
        title.setText("Busqueda avanzada");
        ...
        new Main2Activity.DownloadFilesTask().execute();
        ...
        list.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), list, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(Main2Activity.this, LibraryView.class);
        ...
        mFilter.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                (Main2Activity.this).mAdapter.getFilter().filter(s);
            }
